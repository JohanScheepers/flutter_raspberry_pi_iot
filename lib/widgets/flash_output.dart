...
class OutputFlash extends StatefulWidget {
  const OutputFlash(
      {super.key,
  ...
  @override
  State<OutputFlash> createState() => _OutputFlashState();
}

class _OutputFlashState extends State<OutputFlash> {
  final bool _outputValue = true;
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: ledStateColorButton,
                border: Border.all(width: 2.0, color: Colors.white70),
                borderRadius: BorderRadius.circular(15.0),
              ),
              child: Center(
                child: Text(
                  '${widget.ledName} ${widget.gpio}: $ledState',
                  style: styleText,
                ),
              ),
            ),
