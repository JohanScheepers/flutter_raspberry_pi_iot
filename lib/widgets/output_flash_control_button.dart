...
class OutputFlashControlButton extends StatefulWidget {
  const OutputFlashControlButton(
      {super.key,
  ...
  @override
  State<OutputFlashControlButton> createState() =>
      _OutputFlashControlButtonState();
}

class _OutputFlashControlButtonState extends State<OutputFlashControlButton> {
            ...
            child: ElevatedButton(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    outputervice.flashLed(_outputValue, 500, 500);
                  });
                },
                child: Text(
